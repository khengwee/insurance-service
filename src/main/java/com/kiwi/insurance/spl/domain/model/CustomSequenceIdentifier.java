...
public class CustomSequenceIdentifier implements IdentifierGenerator, Configurable {
	...
	public Serializable generate(SessionImplementor session, Object obj) {
		...
		return sequencePrefix + StringUtils.leftPad(String.valueOf(seqValue), 5, '0');
	}
}
